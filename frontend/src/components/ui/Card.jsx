function Card({ heading, subtitle, number }) {
    return (
    <div className="w-full rounded-2xl border-2 border-dashed border-primary bg-secondary p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:p-6 md:min-h-[22rem]">
